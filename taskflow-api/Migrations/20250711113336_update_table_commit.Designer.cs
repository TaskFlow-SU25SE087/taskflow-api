...
namespace taskflow_api.Migrations
{
    ...
    [Migration("20250711113336_update_table_commit")]
    partial class update_table_commit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("taskflow_api.TaskFlow.Domain.Entities.UserIntegration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("taskflow_api.TaskFlow.Domain.Entities.UserIntegration", b =>
                {
                    b.HasOne("taskflow_api.TaskFlow.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
